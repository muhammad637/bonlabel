...
@section('container')
    ...
    <table  class="table  table-striped my-2" id="example" style="width:100%">
        <thead>
            <tr>
                <th>#</th>
                <th>Nama User</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <!-- Modal Update-->
                <div class="modal fade" id="Update-{{ $order->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-body">
                                ...
                                <form action="/orderan/{{ $order->id }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label for="validationDefault04" class="form-label">Nama Kertas Produk</label>
                                            <select class="form-select" id="validationDefault04" required name="product_id">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-5 ms-1">
                                                        ...
                                                        <label class="form-check-label" for="tolak-{{$order->id}}">
                                                            <h3><div class="badge bg-danger"><i
                                                                class="bi bi-x-circle"></i> tolak </div></h3>
                                                        </label>
                                                </div>
                                                <div class="col-5">
                                                        ...
                                                        <label class="form-check-label" for="terima-{{$order->id}}">
                                                            <h3><div class="badge bg-success "><i
                                                                class="bi bi-check2-circle"></i> terima </div></h3>
                                                        </label>
                                                </div>
                                            </div>
