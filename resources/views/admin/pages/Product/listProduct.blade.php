            ...
            <ul>
                @foreach ($datas as $data)
                    <li>
                        ...
                        <p>aksi : <a href="master/product/{{ $data->id }}/edit" class="badge bg-info text-transform-none">
                                edit</a> |
                            @if ($data->status == 'aktif')
                                <form action="master/product/{{ $data->id }}/nonaktif" method="post" class="inline-block">
                                    @method('put')
                                    @csrf
